    ...
    if (sessionId) {
      ...
      fetch(
        ...
        .catch((err) => {
          setError(
            err.message ||
              "Failed to fetch receipt. Please try refreshing the page."
          );
          setLoading(false);
        });
    } else {
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md text-center animate-fade-in">
                ...
                <div className="bg-gradient-to-br from-cyan-50 to-blue-100 border-2 border-cyan-400 rounded-xl p-6 mb-6 text-left">
                  <div className="mb-2 text-gray-700">
                    Name: <span className="font-medium">{receipt.name}</span>
                  </div>
                  <div className="mb-2 text-gray-700">
                    Email: <span className="font-medium">{receipt.email}</span>
                  </div>
                  <div className="mb-2 text-gray-700">
                    Amount:{" "}
